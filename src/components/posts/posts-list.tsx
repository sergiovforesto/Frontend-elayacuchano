    ...
    return (
        <>
            {posts.length > 0 ? (
                ...
                <div className='rounded-lg bg-white border flex items-center justify-center max-h-[200px] h-full'>
                    <h3 className='text-2xl font-bold text-gray-900'>No hay publicaciones 😥</h3>
                </div>
            )}
            {
                isLoading && (
